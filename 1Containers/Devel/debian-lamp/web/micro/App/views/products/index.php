        ...
        <table class="table table-hover table-stripped">
            ...
            <?php foreach ($fetchAll as $product) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo URL . 'product/edit/' . htmlspecialchars($product->id, ENT_QUOTES, 'UTF-8'); ?>">Edit</a></td>
                    <td><a onclick="return confirm('Really delete ?')" href="<?php echo URL . 'product/delete/' . htmlspecialchars($product->id, ENT_QUOTES, 'UTF-8'); ?>">Delete</a></td>
                </tr>
            <?php } ?>
            </tbody>
        </table>
